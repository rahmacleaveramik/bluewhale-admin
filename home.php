	   ...
	   $query=mysql_query("select * from tb_tugasakhir
                ...
                ?>;
                   <table border=1 cellspasing=0>
                      <tr>
                        <th height="20" width="20">No</th><th height="30" width="20">NPM</th><th width="100">Jenis</th><th width="300" height="20">Judul</th><th>Thn Lulus</th><th width="300" height="20">Abstraksi</th><th width="40" height="30">Lihat file TA</th>
                      </tr> 
                    <?
                    $no=1;
