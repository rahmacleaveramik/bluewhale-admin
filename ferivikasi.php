...
$urldownload = base64_decode($_POST['url']);
	...
	if(isset($_POST['kode'])){	
		...
		else
		{
		    ...
		    echo "<p><b>Kode verifikasi salah</b></p> <a href='http://localhost/bluewhale-admin/link.php?c=$_POST[url]'>kembali</a>";
		}
	}
	else{
		echo "Anda belum memasukkan kode verifikasi <a href='http://localhost/bluewhale-admin/link.php?c=$_POST[url]'>kembali</a>";
	}
