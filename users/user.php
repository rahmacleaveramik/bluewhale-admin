...
if(isset($_SESSION['s_emailCust'])){
	...
	<table>
		...
		<tr>
			...
			<td>&nbsp;Selamat <?php echo Greetings(); ?>, <b><a style="cursor:pointer;" onclick="javascript: sendRequest('users/profil.php', '', 'content', 'div', '');"><?php echo UcFirst($_SESSION['s_namaCust']); ?></a></b></td>
		</tr>
		<tr>
