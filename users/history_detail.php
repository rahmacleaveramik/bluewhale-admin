...
if(isset($_SESSION['s_emailCust'])){	
	...
	while(list($idBaju, $jumlahBaju, $subtotal) = mysql_fetch_row($hqData)){
		list($namaBaju, $hargaBaju) = mysql_fetch_row(mysql_query("SELECT nama, harga FROM _baju WHERE id_baju = '$idBaju'"));
